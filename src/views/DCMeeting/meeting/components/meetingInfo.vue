...
<!--      </template>-->
<!--      <div class="header">-->
<!--        <div class="title">【提示】你预约了xxxx-xxxx(时间）的xxx会议场景，会议名称xxxxxx，总计费用xxxxxx快币，您当前有xxxxxx快币。</div>-->
<!--      </div>-->
<!--      <div class="footer">-->
<!--        <a-button type="primary" shape="round" class="custom-button" @click="next" >确认申请</a-button>-->
<!--      </div>-->
<!--    </a-modal>-->
  </div>
